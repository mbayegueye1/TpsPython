...
print(pers1.nom, pers1.prenom, pers1.adresse.num_rue, pers1.adresse.libelle, pers1.adresse.code_postal, pers1.adresse.ville)
print(pers2.nom, pers2.prenom, pers2.adresse.num_rue, pers2.adresse.libelle, pers2.adresse.code_postal, pers2.adresse.ville)
